...
int main(void) {
  ...
  // Start Advertising
  // uint8_t ble_data[BLE_GAP_ADV_SET_DATA_SIZE_MAX] = { 0x02, 0x01, 0x06, 0x0A, 0x09, 0x43, 0x53, 0x33, 0x39, 0x37, 0x2F, 0x34, 0x39, 0x37, 0x0E, 0x24, 0x16, '/', '/', 'g', 'o', 'o', 'g', 'l', 'e', '.', 'c', 'o', 'm' };
  char url[11] = {'g', 'o', 'o', 'g', 'l', 'e', '.', 'c', 'o', 'm', 0x00};
